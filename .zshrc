...
autoload -Uz add-zsh-hook vcs_info old tmx mkf
...
# <C-l> normally clears, but tmux navigation overrides that, so a faster way to
# clear the screen is still helpful
alias cl="clear"
